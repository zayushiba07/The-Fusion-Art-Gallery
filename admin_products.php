      ...
      $message[] = 'Product Name Already Added';
         ...
         elseif($image_type != "image/png" && $image_type != "image/jpg" && $image_type != "image/jpeg")
         {
            ...
            move_uploaded_file($image_tmp_name, $image_folder);
             mysqli_query($conn, "INSERT INTO `products`(name,artist, price, image) VALUES('$name','$artist', '$price', '$image')") or die('query failed');
...
if(isset($_POST['update_product'])){
   ...
   mysqli_query($conn, "UPDATE `products` SET name = '$update_name',artist='$update_artist',price = '$update_price' WHERE product_id = '$update_p_id'") or die('query failed');
...
<section class="add-products">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      ?>
      <input type="text" name="name" class="box" placeholder="Enter Product Name" required  pattern="[A-Za-z]+" title="only alphabet character is allowed" class="box">
      <input type="text" name="artist" class="box" placeholder="Enter Product Artist Name" required pattern="[A-Za-z]+" title="only alphabet character is allowed" class="box">
...
<section class="edit-product-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="text" name="update_artist" value="<?php echo $fetch_update['artist']; ?>" class="box" required placeholder="Enter Product Artist Name">
