...
<section class="placed-orders">
   ...
   <div class="box-container">
      ...
      <?php
         ...
         $q=mysqli_query($conn,"SELECT * FROM `payment_status` WHERE `user_id` = '$user_id'");
         if(mysqli_num_rows($order_query) > 0){
            while($fetch_orders = mysqli_fetch_assoc($order_query) and $ab = mysqli_fetch_assoc($q)){
      ?>
      <div class="box">
         ...
         <p> Payment Method : <span><?php if($ab['method'] == 'cash on de'){echo 'COD';} else{ echo $ab['method']; } ?></span> </p>
         ...
         <p> Payment Status : <span style="color:<?php if($ab['payment_status'] == 'pending'){ echo 'rgb(24, 234, 237)'; }else{ echo 'rgb(24, 234, 237)'; } ?>;"><?php if($ab['payment_status'] == 'pending'){ echo 'Panding'; }else{ echo 'Completed'; } ?></span> </p>
          <form align="center" method="post">
              ...
              if(isset($_GET['delete'])){
                 ...
                 mysqli_query($conn, "DELETE FROM `payment_status` WHERE id = '$delete_id'") or die('query failed');
