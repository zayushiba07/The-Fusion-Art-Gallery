<?php
   ...
   $user_id=$_SESSION['user_id'];
    ...
    if(isset($_POST['sub']))
    {
        ...
        mysqli_query($conn,"INSERT INTO `payment_status`( `user_id` , `name`, `product_name`, `price`, `payment_status`, `method`) VALUES ('$user_id','$name','$total_products','$cart_total','padding','card')");
